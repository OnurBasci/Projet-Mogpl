...
def question_9():
    """
        ...
        aléatoire
    """
    print("[INFO] Question 9 en cours...")
    analyse.anlayse_nb_iter_by_random_graph(nb_graphs=10,nb_vertex=100)
...
def tests_supplementaires():
    print("[INFO] Tests supplémentaires... (ça prend du temps)")
...
def question_11():
    ...
    réponse
    """
    print("[INFO] Question 11 en cours... (ça prend du temps)")
